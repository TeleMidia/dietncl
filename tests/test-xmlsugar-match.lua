...
local t = {root:match ('y')}
assert (#t == 3)
assert (t[1].id == 'y1')
assert (t[2].id == 'y2')
assert (t[3].id == 'y3')

local t = {root:match ('y', 'a')}
assert (#t == 2)
assert (t[1].id == 'y1')
assert (t[2].id == 'y2')

local t = {root:match ('y', 'a', '4')}
assert (#t == 1)
assert (t[1].id == 'y2')

local t = {root:match (nil, 'id')}
assert (#t == 3)
assert (t[1]:tag () == 'y' and t[1].id == 'y1')
assert (t[2]:tag () == 'y' and t[2].id == 'y2')
assert (t[3]:tag () == 'y' and t[3].id == 'y3')

local t = {root:match (nil, 'a', '4')}
assert (#t == 1)
...
local t = {root:match ('ro.t', nil, nil, 4)}
assert (t[1]:tag () == 'root' and #t == 1)

local root = xml.eval ("<root abc='xyz'/>")
...
local t = {root:match (nil, '^[^a]*$', '^[a-z][0-9]$', 3)}
assert (#t == 2)
assert (t[1].id == 'y1')
assert (t[2].id == 'y2')
