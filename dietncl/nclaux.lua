...
---
-- Obtain the number of seconds denoted by NCL time string STR or nil, if
-- STR is not a valid NCL time string.
-- @param str NCL time string.
-- @return number of seconds denoted by STR.
-- @return 'nil' if STR is invalid.
...
-- @param ncl NCL document.
-- @return the last XML-ID string, if gen_id was called for NCL.
-- @return the prefix of the last XML-ID, if gen_id was called for NCL.
-- @return the serial of the last XML-ID, if gen_id was called for NCL.
